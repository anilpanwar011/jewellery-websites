...
export default function MyProfile() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="max-w-4xl mx-auto bg-white shadow rounded-lg p-6 md:p-10">
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-4 md:mb-0">My Profile</h1>
          <button
          ...
          <div className="flex-1 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                disabled={!edit}
                className={`w-full border rounded-md px-3 py-2 mt-1 focus:ring-2 focus:ring-yellow-500 outline-none resize-none ${
                  edit ? "bg-white" : "bg-gray-100"
                }`}
              />
            </div>
