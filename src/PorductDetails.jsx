  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTG9jzQTdocpMMCuIQHB9orS7nxxmwgo8Zexg&s"
            alt="Gold necklace"
          ...
          <div className="flex gap-4 mt-4">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTG9jzQTdocpMMCuIQHB9orS7nxxmwgo8Zexg&s"
              alt="thumb"
              className="w-20 h-20 border hover:border-yellow-500 cursor-pointer"
            />
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTG9jzQTdocpMMCuIQHB9orS7nxxmwgo8Zexg&s"
              alt="thumb"
        ...
        {/* Product Info */}
        <div>
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Diamond Gold Necklace</h1>
          <div className="flex items-center gap-2 mb-4">
            <span className="text-yellow-400 text-lg">⭐⭐⭐⭐⭐</span>
            <span className="text-gray-600 text-sm">(54 reviews)</span>
          </div>

          {/* Price */}
          <p className="text-2xl font-semibold text-yellow-600 mb-2">₹24,999</p>
          <p className="text-green-600 font-medium mb-4">✔️ In Stock</p>

          {/* Description */}
          <p className="text-gray-600 mb-6">
            Elegant 18K gold ring studded with certified diamonds. Perfect for weddings,
            engagements and special occasions.
          </p>

          {/* Size Options */}
          <div className="mb-6">
            <label className="block mb-2 text-gray-700 font-medium">Select Size:</label>
          ...
          <div className="flex gap-4">
            <Link to={"/cart"}>
             <button className="bg-yellow-600 text-white px-6 py-3 shadow hover:bg-yellow-700 transition">
              🛒 Add to Cart
            </button>
            </Link>
           <Link to={"/wishlist"}>
            <button className="bg-gray-800 text-white px-6 py-3 shadow hover:bg-black transition">
              ❤️ Add to Wishlist
            </button>
           </Link>
          </div>
          ...
          {/* Delivery Info */}
          <p className="mt-6 text-sm text-gray-500">🚚 Free Shipping | 7 Days Return</p>
          <p className="text-sm text-gray-500">💎 BIS Hallmarked | Certified Diamonds</p>
        </div>
      </div>
